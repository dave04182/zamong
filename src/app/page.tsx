    ...
    <div style={{ minHeight: '100vh', background: '#FDFAF4', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ padding: '40px 64px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '48px' }}>
          ...
          <Link href="/gallery?ai=true" style={{ padding: '8px 16px', borderRadius: '20px', fontSize: '13px', background: '#EFE6D5', color: '#8A6F4A', border: '0.5px solid #EDD9BC', textDecoration: 'none' }}>✨ AI 창작관</Link>
        </div>
